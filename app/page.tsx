  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-1 grid md:grid-cols-2">
        <div className="slip-divider bg-grain relative overflow-hidden flex flex-col justify-center px-8 md:px-14 py-10 md:py-12 bg-ink text-white">
          <div
          ...
          <div className="relative z-10">
            ...
            <p
              className="eyebrow mb-4 text-gold animate-fade-up"
              style={{ animationDelay: "0.1s", opacity: 0 }}
            >
              NOUN - WAEC - NECO - JAMB
            </p>
            <h1
              className="font-display text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] tracking-tight mb-4 max-w-xl animate-fade-up"
              style={{ animationDelay: "0.15s", opacity: 0 }}
            >
              Everything between you and your <span className="italic font-medium text-gold">next result slip</span>.
            </h1>
            <p
              className="text-white/80 text-base md:text-lg max-w-md mb-8 leading-relaxed animate-fade-up"
            ...
            <div
              className="flex flex-wrap gap-2.5 font-mono-brand text-xs animate-fade-up"
        ...
        <div className="bg-dot-grid relative overflow-hidden flex flex-col items-center justify-center px-8 py-10 md:py-12 gap-4 bg-paper">
          <svg
            viewBox="0 0 240 240"
          ...
          <div className="relative z-10 flex flex-col items-center gap-3.5">
            <p className="eyebrow text-muted mb-1 animate-fade-up" style={{ opacity: 0 }}>
              Get started
            </p>
            <Link
              href="/login"
              className="btn-primary group w-full max-w-xs text-sm py-3 animate-fade-up-scale"
              style={{ animationDelay: "0.1s", opacity: 0 }}
            >
              <span>Log in</span>
            ...
            <Link
              href="/signup"
              className="group w-full max-w-xs text-center rounded-xl py-3 text-sm font-semibold border border-line text-ink transition-all duration-200 ease-out hover:border-gold hover:-translate-y-0.5 hover:shadow-button animate-fade-up-scale"
              style={{ animationDelay: "0.15s", opacity: 0 }}
            >
